...
const LeaderboardCard = (props) => {
    ...
    return ( 
        <div style={{display:'flex', backgroundColor:props.prompt?'rgb(194, 255, 232)':(props.position%2===0)?'rgb(255,226,188)':'rgb(240, 240, 240)', alignItems:'center', padding:'6px', borderRadius:'4px', marginTop:'10px', justifyContent:'space-between', fontFamily:'strikefighter'}}>
